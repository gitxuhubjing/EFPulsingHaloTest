...
- (id)init {
    ...
    if (self) {
        ...
        self.subLayer.bounds = CGRectMake(0, 0, (self.radius * 2) -20, (self.radius * 2) - 20);
        self.subLayer.cornerRadius = self.radius - 10;
        self.subLayer.position = CGPointMake(self.radius, self.radius);
...
- (void)setRadius:(CGFloat)radius {
    ...
    self.subLayer.bounds = CGRectMake(0, 0, (_radius * 2) -20, (_radius * 2) - 20);
    self.subLayer.cornerRadius = _radius - 10;
    self.subLayer.position = CGPointMake(_radius, _radius);
}
